...
$time = Get-Date
$flags = 'create-instance --instance="OctopusServer" --config "C:\Octopus\OctopusServer.config"'
...
$time = Get-Date
$flags = 'database --instance "OctopusServer" --create --grant "NT AUTHORITY\SYSTEM"'
Write-output "
==================================
...
$time = Get-Date
$flags = 'service --instance="OctopusServer" --stop'
Write-Output "
=================================
...
$time = Get-Date
$flags = 'admin --instance "OctopusServer" --username "admin" --email "admin@admin.com" --password "Vagrant!"'
Write-Output "
=================================
...
$time = Get-Date
$flags = 'service --instance="OctopusServer" --install --reconfigure --start'
Write-Output "
==================================
...
New-Item C:\Octopus -ItemType Directory -Force
Copy-Item -Path "C:\Program Files\Octopus Deploy\Octopus\Octopus.config" -Destination "C:\Octopus\OctopusServer.config"

$secpasswd = ConvertTo-SecureString vagrant -AsPlainText -Force
$credential = New-Object System.Management.Automation.PSCredential ("Administrator", $secpasswd)

Register-ScheduledJob -Name "InstallOcto" -ScriptBlock $ConfScript -Credential $credential -MaxResultcount 30 -ScheduledJobOption (New-ScheduledJobOption -RunElevated) -Trigger (New-JobTrigger -AtStartup)
